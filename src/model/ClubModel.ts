...
export const clubModelToFirestore = (club: ClubModel) => ({
  name: club.name,
...
export const coachToClubRequestToFirestore = (request: CoachToClubRequest) => ({
  id: request.id,
...
// --------- Helpers ---------
export const isPending = (req: CoachToClubRequest): boolean => req.status === 'pending';
export const isApproved = (req: CoachToClubRequest): boolean => req.status === 'approved';
export const isRejected = (req: CoachToClubRequest): boolean => req.status === 'rejected';
